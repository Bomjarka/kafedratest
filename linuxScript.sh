...
echo -e
echo -e "Checking string the quick brown fox jumps over the lazy dog; Await: brown-1 dog-1 fox-1 jumps-1 lazy-1 over-1 quick-1 the-2"
java -jar stringTest.jar the quick brown fox jumps over the lazy dog
echo -e
echo -e "Checking string software engineering is very interesting!; Await: engineering-1 interesting-1 is-1 software-1 very-1"
